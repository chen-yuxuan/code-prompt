...
def run_hcc(
    ...
    testset = json.load(open("data/hcc/hcc-staging-test.json", "r"))
    if shots > 0:
        trainset = json.load(open("data/hcc/hcc-staging-train.json", "r"))
    ...
    logging.info(f"HCC results saved to {output_path}")
